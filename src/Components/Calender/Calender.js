...
const Scheduler = () => {
  ...
  const [events, setEvents] = useState([
    ...
    },
    {
      ...
      start: new Date("2024-04-13T11:00:00"),
      end: new Date("2024-04-13T12:00:00"),
      resourceId: "Shyam",
    },
    {
      id: 3,
      title: "Team Meeting 3",
      start: new Date("2024-04-13T14:00:00"),
      end: new Date("2024-04-13T15:00:00"),
      resourceId: "Ram",
    },
    {
      id: 4,
      title: "Team Meeting 4",
      start: new Date("2024-04-13T16:00:00"),
      end: new Date("2024-04-13T17:00:00"),
      resourceId: "Shyam",
    },
    {
      id: 5,
      title: "Team Meeting 5",
      start: new Date("2024-04-13T10:30:00"),
    ...
    },
    {
      ...
      start: new Date("2024-04-13T10:00:00"),
      end: new Date("2024-04-13T12:00:00"),
      resourceId: "Ganesh",
    },
    {
    ...
    },
    {
      id: 8,
      title: "Team Meeting 1",
      start: new Date("2024-04-13T08:00:00"),
      end: new Date("2024-04-13T10:00:00"),
      resourceId: "Krishna",
    }
  ]);
